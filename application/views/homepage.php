...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-white sticky-top">
      <div class="container position-relative py-2">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav mx-auto" id="menu-data">
          </div>
        </div>
        <div class="position-absolute d-flex align-items-center" style="right:0; top: 0; bottom:0">
          <a id="nav-button" class="btn btn-primary rounded-0" href="#">      
          </a>
        </div>
      </div>
    </nav>
    ...
    <header class="container pt-5">
      <h1 id="hero-tagline" class="mb-5 fw-bolder text-uppercase text-center"></h1>
      ...
      <div class="container py-4">
        <div class="row">
          <div class="col-6 d-flex justify-content-center">
            <img id="about-img" height="600px" alt="">
          </div>
    ...
    <section id="instagram" style="background-color:#F3F4F6;">
      <div class="container py-5">
        <div id="instagram-data" class="row mb-5" style="--bs-gutter-x: 2rem; --bs-gutter-y: 2rem">
            ...
            <div>
              ...
              <div class="text-muted d-flex gap-4 mt-4">
                <div>
                  ...
                  <div id="location-opening-hours">Opens at 09.00 AM - 22.00 PM</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Gallery -->
    <section id="gallery">
      <div id="galleries-data" class="row" style="--bs-gutter-x: 0rem;">
      </div>
    </section>

    <!-- Footer Banner -->
    <section id="footer-image" style="background-color:#F3F4F6; background-position: bottom center; background-repeat: no-repeat">
      <div class="text-center" style="padding-top: 7rem; padding-bottom: 7rem;">
        <h1 id="footer-tagline"></h1>
      </div>
    </section>
    ...
    <footer style="background-color:#C8A27A;">
      <div class="container py-5">
        <div class="row">
          <div class="col-6">
            <span id="copyright" class="text-white"></span>
          </div>
          <div class="col-6 d-flex justify-content-end gap-4">
          <a id="link-whatsapp" href="#" class="">
          ...
          <a id="link-instagram" href="#" class="">
    ...
    $.get("https://core-kopiku.sawala.dev/api/instagrams?populate=*", function(data, status){
      ...
      $("#instagram-data").html(dataHtml)
    });

    //Get Data About and Hero
    ...
    $.get("https://core-kopiku.sawala.dev/api/setting?populate=*", function(data, status){
      ...
      //link social media
      $("#link-facebook").attr('href', data.data.attributes.facebook_link)
      $("#link-instagram").attr('href', data.data.attributes.instagram_link)
      $("#link-whatsapp").attr('href', data.data.attributes.whatsapp_link)
      $("#link-twitter").attr('href', data.data.attributes.twitter_link)

      //footer
      $("#copyright").text(data.data.attributes.copyright)
      $("#footer-tagline").text(data.data.attributes.footer_tagline)
      $("#footer-image").css('background-image', `url(${data.data.attributes.footer_image.data.attributes.url})`)
      ...
      //Logo
      $("#logo").attr('src', data.data.attributes.logo.data.attributes.url)
      $("#title").text(data.data.attributes.title)
      $("#nav-button").text(data.data.attributes.order_text)
    });
  </script>
  </body>
</html>
